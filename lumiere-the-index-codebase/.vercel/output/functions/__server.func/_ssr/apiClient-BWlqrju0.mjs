//#region node_modules/.nitro/vite/services/ssr/assets/apiClient-BWlqrju0.js
/**
* Lumière API Client
...
*/
var DEFAULT_DEV_BASE = "http://localhost:8000";
...
var PROD_FALLBACK_BASE = "https://lumiere-index-production.up.railway.app";
function getApiBase() {
	{
		const runtime = window.__API_BASE_URL__;

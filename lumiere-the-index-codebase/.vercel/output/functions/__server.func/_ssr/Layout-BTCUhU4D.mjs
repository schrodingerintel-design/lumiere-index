...
import { f as getTopFilms, g as subscribeNewsletter, h as searchTmdbMovie, m as searchFilms, v as tmdbPosterUrl } from "./apiClient-BBCAVRqq.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/Layout-BTCUhU4D.js
...
function TopNav({ onMenu, onSearch }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "glass mx-auto flex h-12 items-center justify-between rounded-full px-3 lg:px-5",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, {
					className: "mx-2 hidden w-36 md:flex xl:w-48",
					onOpen: onSearch
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-2",

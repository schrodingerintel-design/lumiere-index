...
import { f as getTopFilms, g as subscribeNewsletter, h as searchTmdbMovie, m as searchFilms, v as tmdbPosterUrl } from "./apiClient-OpsbjiRR.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/Layout-B2NEJ6Q7.js
...
function MobileSidebar({ open, onClose, onSearch }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "glass absolute left-2 top-2 bottom-2 w-72 overflow-hidden rounded-2xl animate-fade-up",
...
var topLinks = NAV_ITEMS.filter((item) => item.to !== "/" && item.to !== "/new-entries" && item.to !== "/genres" && item.to !== "/calendar").map(({ to, label }) => ({
	to,
	label
}));
function TopNav({ onMenu, onSearch }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: "sticky top-0 z-30 px-4 pt-4 lg:px-6",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "glass mx-auto flex h-14 items-center justify-between rounded-full px-4 lg:px-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							onClick: onMenu,
							className: "rounded-md p-1.5 hover:bg-foreground/5 lg:hidden",
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Menu, { className: "h-5 w-5" })
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/",
							className: "font-serif text-lg lg:hidden",
							children: ["Lumière", /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-primary",
								children: "."
							})]
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SearchBox, {
					className: "mx-2 hidden w-40 md:flex xl:w-56",
					onOpen: onSearch
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "flex items-center gap-3",
...
function Ticker() {
	const text = "Real Time Rankings · Real People · Real Conversations · Real Audience Insights · ".repeat(3);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
		className: "mt-16 overflow-hidden bg-primary py-6 text-primary-foreground dark:bg-ink dark:text-cream",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function SearchModal({ open, onClose }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Dialog, {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(DialogPortal, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogOverlay, { className: "fixed inset-0 z-50 bg-foreground/10 backdrop-blur-sm" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DialogContent, {
			"aria-label": "Search films",
			className: "fixed left-1/2 top-[15vh] z-50 w-full max-w-xl -translate-x-1/2 px-4 outline-none animate-fade-up",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "glass rounded-2xl border border-foreground/10 shadow-2xl",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: debounced.length >= 2 ? isFetching && results.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: results.map((film, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									...
									className: `flex items-center gap-3 px-5 py-2.5 transition ${i === highlighted ? "bg-foreground/5" : ""}`,
									children: [
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						...
						children: "The real-time cultural index measuring the films and series the world is watching, discussing, and discovering — 0% critic weight."
					})]
				}),
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
				...
				className: "font-mono",
				children: "0% critic weight · audience-driven · refreshed every 15 minutes"
			})]
		})]
	});
}

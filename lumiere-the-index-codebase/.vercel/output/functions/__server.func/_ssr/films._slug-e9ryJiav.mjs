...
import { c as getTmdbMovieVideos, d as getTmdbWatchProviders, h as searchTmdbMovie, n as getFilmDetail, s as getTmdbMovieDetails, t as TMDB_IMG, v as tmdbPosterUrl } from "./apiClient-BWlqrju0.mjs";
...
import { t as Route } from "./films._slug-NxLzfcCV.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/films._slug-e9ryJiav.js
...
function useWatchlist(slug) {
	...
	(0, import_react.useEffect)(() => {
		setSaved(JSON.parse(localStorage.getItem(key) ?? "[]").includes(slug));
	}, [slug]);
	const toggle = () => {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SourceBadge, {
							...
							value: tmdbPopularity > 0 ? tmdbPopularity > 200 ? "Very High" : tmdbPopularity > 80 ? "High" : "Moderate" : "—",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: film.confidence === "insufficient" || film.confidence == null && (film.sample_size ?? 0) < 5 ? `"${film.title}" has just entered tracking — not enough audience signal yet to assess its trajectory.` : `"${film.title}" holds rank #${film.rank || "—"} on the Lumière Index, backed by ${(film.sample_size ?? film.mentions_total).toLocaleString()} tracked audience signals this cycle.`
					})]
				})
			]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {

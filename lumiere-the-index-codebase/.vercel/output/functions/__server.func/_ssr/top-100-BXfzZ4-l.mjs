import { a as getNewReleaseFilms } from "./apiClient-OpsbjiRR.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/top-100-BXfzZ4-l.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Layout, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				children: "Highest-rated newly released films on the Index, calculated from audience sentiment and engagement signals."
			})
		]
		...
		children: [error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			className: "glass overflow-hidden rounded-2xl border border-foreground/10",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "grid grid-cols-[50px_1fr_70px_70px] items-center gap-3 border-b border-foreground/10 px-4 py-3 text-[10px] uppercase tracking-[0.18em] text-muted-foreground sm:grid-cols-[60px_60px_1fr_90px_90px_90px]",
				children: [
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "hidden sm:block",
							children: f.prev_rank == null && isNewRelease(f) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "font-mono text-sm tabular text-primary font-semibold",
							children: f.score?.toFixed(1)
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "text-right font-mono text-xs tabular text-muted-foreground font-medium",
							children: signals
						})
					]
				}) }, f.slug);

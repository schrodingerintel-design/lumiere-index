      ...
      <div className="relative aspect-[2/3] overflow-hidden">
        ...
        <div className="absolute inset-x-3 bottom-3 text-white z-10">
          <div className="flex items-center gap-1.5 font-mono text-xs text-white/80">
            ...
            Debuted {formatDate(film.debut_date)}
          </div>
    ...
    <Layout>
      <section className="px-4 pt-6 lg:px-6">
        ...
        <p className="mt-3 max-w-xl text-sm text-muted-foreground">
          Films entering The Index for the first time — where they debuted and when.
          Each film appears here once, at its debut.
        </p>
        <Link
          to="/calendar"
        ...
        <div className="mb-4 flex items-center gap-2">
          ...
          <div>
            <div className="text-[10px] uppercase tracking-[0.22em] text-muted-foreground">
              First appearances on The Index
            </div>
            <h2 className="mt-1 font-serif text-3xl">Latest Debuts</h2>
          </div>
        </div>
